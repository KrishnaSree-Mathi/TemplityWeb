...
$sql1 = "UPDATE areg1 SET EmailID='$email' WHERE Name='name'";
if(mysqli_query($link, $sql1)){
    echo ' <center><p style="font-size:24;color:blue;">Records were updated successfully.</p></center>';
} else {
    echo "ERROR: Could not able to execute $sql. " . mysqli_error($link) .' <center><p style="font-size:24;color:blue;">Records are not updated.</p></center>';
}
