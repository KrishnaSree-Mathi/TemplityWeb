  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="videup.html"><span class="glyphicon glyphicon-log-in"></span> Admin</a></li>
		<li><a href="developersframes.html">Developers</a></li>
	  </ul>
    </div>
...
<br>
<center><u><h1 style="color:blue">No.of Registered people </u></center>
...
$result = mysqli_query($link, "SELECT * FROM areg1");
$num_rows = mysqli_num_rows($result);

echo "<h2 style=\"color:red\"><center>$num_rows are the no.of forms submitted.<br> Thank You</h2></center>";
...
<footer class="container-fluid text-center" style="a:hover
  ...
  <center><a href="https://www.facebook.com/sircrrcoeofficial/" target="_blank"><img src="favi.png" ></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="login.html" target="_parent">Admin</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="developers.html" target="_parent">Developers</a></center>
</footer>
