...
<br>
<center><h1 style="color:blue">Registered Data based on department</h1></center>
<?php
...
$sql = "SELECT * FROM areg1 where Dept='$dept'";/* or RegistrationNo='$reg' or YearofJoining='$yoj'";*/
