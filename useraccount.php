...
$mail->SMTPAuth = true;
$mail->Username = 'krishnasreemathi44@gmail.com';
$mail->Password = '315177111069';
$mail->SMTPSecure = 'tls';
$mail->Port = 587;
//start session
session_start();
...
$mail->setFrom('krishnasreemathi44@gmail.com', 'Admin of Alumni manohar');
$mail->addReplyTo('krishnasreemathi44@gmail.com', 'Admin of Alumni manohar');

// Add a recipient
$mail->addAddress('maram.manohar97@gmail.com');
...
if(isset($_POST['signupSubmit'])){
    ...
    $redirectURL = ($sessData['status']['type'] == 'success')?'indexfgp.php':'registration.php';
...
if(isset($_POST['forgotSubmit'])){
    ...
    if(!empty($_POST['email'])){
        ...
        if($prevUser > 0){
            ...
            if($update){
                $resetPassLink = 'http://localhost/alumni/resetPassword.php?fp_code='.$uniqidStr;
                
                //get user details
                $conn['where'] = array('email'=>$_POST['email']);
                $conn['return_type'] = 'single';
                ...
                <br/><br/>Regards,
                <br/>Administrator of Alumni<br>Krishna Sree';
                //set content-type header for sending HTML email
                $headers = "MIME-Version: 1.0" . "\r\n";
                $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
                //additional headers
                $headers .= 'From: Administrator Krishna<krishnasreemathi44@gmail.com>' . "\r\n";
                //send email
    ...
    //store reset password status into the session
    $_SESSION['sessData'] = $sessData;
    $redirectURL = ($sessData['status']['type'] == 'success')?'indexfgp.php':'resetPassword.php?fp_code='.$fp_code;
